function mailMessage(code){
  return "<div style='width: 36rem;'>" +
      ...
      "<h1 style='color: white;'>Pentagon Verification Code</h1></div>" +
      "<div><p>Hey,</p>" +
      "<p style='text-align: justify;text-justify: inter-word;'>We recieved a request that you are making some changes for which you need a verification code use this 6 digit verification code for the same purpose. Your verification Code is :</p>" +
